<script lang="ts">
  ...
  async function loadCards() {
    ...
    try {
      ...
      categories = [
        ...new Set(
          allCards.map((c) => c.category).filter((c): c is string => Boolean(c))
        ),
      ];
...
<main class="app">
  ...
  <header>
    ...
    <div class="header-actions">
      <button class="icon-btn" title="Trộn bài" onclick={shuffle}>⇄</button>
      <button
        class="icon-btn"
        title="Cài đặt"
      ...
      <div class="card-area">
        ...
        <div class="card-actions">
          <button
            ...
            onclick={() => store.toggleStar(currentCard.id)}
            title="Đánh dấu (S)"
          >
          ...
          <div class="nav-btns">
            <button
              class="nav-arrow"
              onclick={() => store.prev(activeCards)}
              title="Trước (←)">←</button
            >
            <button
              class="nav-arrow"
              onclick={() => store.next(activeCards)}
              title="Tiếp (→)">→</button
            >
          </div>
          <button
            ...
            onclick={() => store.markLearned(currentCard.id)}
      ...
      <div class="modal">
        ...
        <div class="modal-actions">
          <button class="btn-secondary" onclick={() => (showSettings = false)}
            >Huỷ</button
          >
          <button class="btn-primary" onclick={saveSettings}>Tải dữ liệu</button
          >
        </div>
      </div>
    </div>
